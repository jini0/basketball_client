                ...
                <div id='director'>
                    <div className='coachProfile'>
                        <div className='profile_area'>
                            ...
                            <h4>기본정보</h4>
                            <ul>
                                <li><span>생년 월일</span> : 1969.03.08</li>
                                <li><span>신장/체중</span> : 188cm / 88kg</li>
                                <li><span>출 신 교</span> : 연세대</li>
                            </ul>
                        </div>
                        <div className='career'>
                            ...
                            <ul>
                                ...
                                <li><span>2017 ~ 현재</span> 원주DB프로미 감독</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <li>
                            <div className='coachProfile'>
                                ...
                                <div className='profile_area'>
                                    ...
                                    <h4>기본정보</h4>
                                    <ul>
                                        <li><span>생년 월일</span> : 1976.05.14</li>
                                        <li><span>신장/체중</span> : 195cm / 90kg</li>
                                        <li><span>출 신 교</span> : 경희대</li>
                                    </ul>
                                </div>
                                <div className='career'>
                                    <h4>주요경력</h4>
                                    <ul>
                                        ...
                                        <li><span>2014</span> 미국연수:NBA D리그 <br/></li>
                                        <li><span></span> 노던 애리조나 선수 코치</li>
                                        <li><span>2017 ~ 현재</span> 원주 DB프로미 코치</li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div className='coachProfile'>
                                ...
                                <div className='profile_area'>
                                    ...
                                    <h4>기본정보</h4>
                                    <ul>
                                        <li><span>생년 월일</span> : 1979.11.09</li>
                                        <li><span>신장/체중</span> : 205cm / 79kg</li>
                                        <li><span>출 신 교</span> : 중앙대</li>
                                    </ul>
                                </div>
                                <div className='career'>
                                    <h4>주요경력</h4>
                                    <ul>
                                        ...
                                        <li><span>2019 ~ 현재</span> 원주 DB프로미 코치</li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div className='coachProfile'>
                                ...
                                <div className='profile_area'>
                                    ...
                                    <h4>기본정보</h4>
                                    <ul>
                                        <li><span>생년 월일</span> : 1984.04.21</li>
                                ...
                                <div className='career'>
                                    ...
                                    <ul>
                                        ...
                                        <li><span>2021 ~ 현재</span> 원주 DB프로미 코치</li>
                                    </ul>
                                </div>
                            </div>
                        </li>
